      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-[#161B22] rounded-2xl border border-[#232A33] overflow-hidden">
          ...
          <div className="px-6 pt-6 pb-5 border-b border-[#232A33]">
            <h1 className="text-[18px] font-bold text-white">Sign in to your account</h1>
            <p className="text-[13px] text-gray-500 mt-1">Select your role to continue</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div>
              ...
              <div className="flex justify-end mt-2">
                <button type="button" className="text-[12px] text-[#E53935] hover:text-red-400">
                  Forgot password?
                </button>
              </div>
            </div>
            ...
            {/* Role access note */}
            <div className="flex items-start gap-2.5 rounded-xl bg-[#0F1117] border border-[#232A33] px-4 py-3">
              <ShieldCheck size={13} className="text-[#E53935] mt-0.5 flex-shrink-0" />
              <p className="text-[11px] text-gray-500 leading-relaxed">
                {selectedRole === "admin" && "Full access to all shipments, users, roles and audit logs."}
                {selectedRole === "warehouse" && "Access to package IDs and shipment status only. Customer data is hidden."}
                {selectedRole === "hub" && "Access to routing and sorting data only. Customer identity stays protected."}
                {selectedRole === "delivery" && "Customer contact info revealed only for your assigned deliveries."}
              </p>
            </div>
        ...
        <p className="text-center text-[12px] text-gray-600 mt-6">
          ...
          <Link to="/register" className="text-[#E53935] hover:text-red-400 font-semibold">
  Register here
</Link>
        </p>
